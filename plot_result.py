...
file='./results/perceptron_multilayer_' + repr(6) + 'e.txt'
...
plt.savefig('./results/multilayer_perceptron_' + repr(num_epocs) + 'e_acc.png')
...
plt.savefig('./results/multilayer_perceptron_' + repr(num_epocs) + 'e_loss.png')
